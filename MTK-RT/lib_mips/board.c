...
volatile gd_t *gd;
#define TOTAL_RTOS_LENGTH 0x8000
...
static int init_func_ram (void)
{
	...
	int board_type = 0;//gd->board_type;
#else
...
#endif
	gd->rtos_end = addr_sp - 1;
	addr_sp -= TOTAL_RTOS_LENGTH;
	gd->rtos_start = addr_sp;

#ifdef DEBUG
	printf("Reserving %dk for RTOS at: %08lX\n",
		TOTAL_RTOS_LENGTH >> 10, addr_sp);
#endif
	/*
...
*/
	...
	rd.cpu_hz = mips_cpu_feq;
	
	extern void rtthread_startup(rd_t *rd);
